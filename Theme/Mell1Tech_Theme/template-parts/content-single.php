...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <header class="entry-header">
    ...
    <span>
      <?php esc_html_e( 'Author: ', 'mell1tech2_theme' ); ?> <?php the_author_posts_link(); ?>
    </span>
  </header><!-- .entry-header -->
  ...
  <div class="entry-body">
    ...
    <div class="entry-content">
      <?php
        ...
        wp_link_pages([
          'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'mell1tech2_theme' ),
          'after'  => '</div>',
        ]);
      ?>
    </div><!-- .entry-content -->
    ...
    <div class="entry-meta">
      ...
      <div class="entry-category-content">
        <span><?php esc_html_e( 'Categories:', 'mell1tech2_theme' ); ?></span>
        <?php the_category( ', ' ); ?>
      </div><!-- .category-title -->
